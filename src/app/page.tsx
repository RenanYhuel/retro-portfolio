                        ...
                        <div className="relative border-4 border-green-400 p-12 bg-black/90 shadow-[0_0_40px_rgba(34,197,94,0.4)] transform hover:scale-[1.02] transition-transform">
                            ...
                            <div className="max-w-3xl mx-auto">
                                <p className="text-lg md:text-xl leading-relaxed border-l-4 border-green-400 pl-6 text-left bg-green-400/5 p-6">
                                    ...
                                    , 16 ans — Développeur fullstack passionné
                                    par l'informatique, l'IA, l'ingénierie et
                                    les défis techniques. Je crée des solutions
                                    interactives et concrètes, du backend au
                                    frontend, tout en explorant l'électronique,
                                    la domotique et la cybersécurité.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-8 overflow-x-auto pb-4 scrollbar-thin scrollbar-thumb-green-400 scrollbar-track-transparent">
                        {testimonials.map((t, i) => (
                            ...
                            >
                                ...
                                <p className="text-right text-cyan-400">
                                    -- {t.author}
                                </p>
                            </div>
                        ))}
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="border-4 border-green-400 p-8 bg-black">
                            ...
                            <p className="leading-relaxed mb-4">
                                Développeur fullstack de 16 ans, passionné par
                                la technologie, l'IA et l'aérospatial. Basé à
                                Paris, j'ai contribué à des projets
                                professionnels (notamment la V2 de{" "}
                                <span className="text-green-400">Stagey</span>)
                                et effectué des stages formateurs — plus
                                récemment un stage chez{" "}
                                <span className="text-cyan-400">DC2Scale</span>{" "}
                                (été 2025) qui a renforcé mes compétences en
                                administration serveur et réseau. Depuis mars
                                2025 je travaille à temps plein chez{" "}
                                <span className="text-yellow-400">Stagey</span>{" "}
                                sur la V2 et le développement mobile.
                            </p>
                            <p className="leading-relaxed mb-4">
                                Mon approche : apprendre par la pratique,
                                documenter mes systèmes et relever des défis
                                techniques concrets. J'affectionne tout
                                particulièrement le backend, les APIs robustes,
                                la cybersécurité, ainsi que l'électronique et la
                                domotique.
                            </p>
                            <p className="leading-relaxed">
                                Objectif : continuer d'apprendre, contribuer à
                                des projets d'envergure (aérospatial /
                                cybersécurité) et partager mes créations.
                            </p>
                        </div>
                    ...
                    <div className="mt-8 border-4 border-cyan-400 p-8 bg-black">
                        ...
                        <div className="space-y-4">
                            {[
                                {
                                    year: "2019",
                                    event: "Début du code à 12 ans — bots Discord et petits projets",
                                },
                                {
                                    year: "2022",
                                    event: "Projet marquant : Stagey / Stagey Platform (V2) — fullstack, AdonisJS & PostgreSQL",
                                },
                                {
                                    year: "Summer 2025",
                                    event: "Stage chez DC2Scale — apprentissages sysadmin et serveur dédié",
                                },
                                {
                                    year: "Mar 2025",
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="border-4 border-green-400 p-6 bg-black">
                            <div className="space-y-4">
                                <div>
                                    <div className="block mb-2 text-cyan-400">
                                        [NOM]
                                    </div>
                                    <input
                                        type="text"
